package com.jdark.aggregate.demo.security.filter;
            ...
            try {
                ...
                if(!StringUtils.isEmpty(username)&&!StringUtils.isEmpty(userId)) {
                    ...
                    if(!StringUtils.isEmpty(authority)){
                        List<Map<String,String>> authorityMap = JsonUtil.jsonToObj(authority,
                    ...
                    //组装参数
                    SelfUserBO selfUserEntity = new SelfUserBO();
